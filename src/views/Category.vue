...
import { useRoute, useRouter } from 'vue-router' // useRouter是创建router，useRoute是获取路由信息
...
const { loading, tableData, currentPage, pageSize ,total, type} = toRefs(state)
</script>